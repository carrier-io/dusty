...
class Reporter(DependentModuleModel, ReporterModel):
    ...
    def __init__(self, context):
        ...
        self.centry = connector.CentryConnector(
            self.config['url'],
    ...
    def fill_config(data_obj):
        ...
        data_obj.insert(len(data_obj), "token", "", comment="Login to REST API")
        data_obj.insert(len(data_obj), "project_id", "1", comment="ID of project to report to")
        data_obj.insert(len(data_obj), "test_id", "1", comment="ID of test to report to")
    ...
    def get_description():
        ...
        return "Centry REST API reporter"
